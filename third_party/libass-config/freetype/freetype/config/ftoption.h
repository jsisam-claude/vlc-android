/* vendored-build ftoption.h for the libass kit - derived from unmodified
 * FreeType VER-2-14-3 include/freetype/config/ftoption.h with exactly three
 * deltas, each marked "vendored build": FT_CONFIG_OPTION_USE_LZW,
 * FT_CONFIG_OPTION_USE_ZLIB and FT_CONFIG_OPTION_SVG are disabled.
 * Everything else is the upstream default. */
/****************************************************************************
 *
 * ftoption.h
 *
...
#define FT_CONFIG_OPTION_INLINE_MULFIX
   ...
   */
/* vendored build: no LZW-compressed PCF support needed
 ...
 */
   ...
   */
/* vendored build: no zlib -> no gzip streams, no WOFF; sfnt/woff2 also off
...
#undef FT_CONFIG_OPTION_USE_MODULE_ERRORS
   ...
   */
/* vendored build: no SVG glyph table support (libass cannot rasterize it)
