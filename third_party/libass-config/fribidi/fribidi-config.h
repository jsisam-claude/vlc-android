/* Hand-instantiated from lib/fribidi-config.h.in (FriBidi 1.0.16, meson
 * values: interface_version = 4 from meson.build, SIZEOF_INT = 4 on win64
 * LLP64 and on all common LP64 hosts). Not copyrighted, in public domain. */
